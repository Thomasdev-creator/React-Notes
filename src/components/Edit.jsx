  ...
  return (
    <div className="w-full p-10">
        ...
        <form onSubmit={handleSubmit}>
            ...
            id="title"
            spellCheck = "false" 
            className="p-2 mt-4 text-md block w-full rounded bg-slate-200" />
              {showValidation.title && (
                <p className="mb-2 text-red-400">Veuillez renseigner un true</p>
            )}
            ...
            className="p-2 text-md block w-full rounded bg-slate-200" />
              {showValidation.subtitle && (
                <p className="mb-2 text-red-400">Veuillez renseigner un sous-titre</p>
            )}
            ...
            <button className="mt-4 bg-slate-100 py-1 px-3 rounded">Enregistrer</button>
