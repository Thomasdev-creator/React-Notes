...
import { deletNote } from "../features/notes"
...
export default function DisplayedNote() {
  ...
  return (
    <div className="p-10">
        ...
        <Link
        to={`/editer/${id}`}
        className="px-2 py-1 text-slate-200 bg-green-600 rounded mr-2">Mettre à jour
        </Link>
        <button
        onClick={() => {
        ...
        className="px-2 py-1 text-slate-200 bg-red-600 rounded mr-2">Supprimer
        </button>
